...
@validate_arguments
def get_features_for_patients(col: str, feature_name: str, patients: tp.List[str] = None):
...
@validate_arguments
def get_patients_by_mutation(mutation: str, mutation_status: bool):
